...
const UI_TRANSLATIONS = {
  en: {
    ...
    save_zone: "Save Zone",
    safe_zone: "Safe Zone",
    no_movement: "Worker No Movement",
    fall_no_movement: "Fall / No Movement",
    proximity_ppe_violation: "Proximity PPE Violation",
  ...
  hi: {
    ...
    no_movement: "कर्मचारी स्थिर",
    fall_no_movement: "गिरना / हिलना नहीं",
    proximity_ppe_violation: "मशीनरी के पास पीपीई उल्लंघन",
    predicted_machinery_collision: "संभावित टकराव",
    predicted_zone_entry: "संभावित क्षेत्र प्रवेश",
    users: "उपयोगकर्ता",
    type: "प्रकार",
    camera: "कैमरा",
    time: "समय",
